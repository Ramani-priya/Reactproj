...
class Contact extends Component{
    ...
    handleSubmit(event) {
        console.log("your response:" + JSON.stringify(this.state));
        alert("your response:" + JSON.stringify(this.state));
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.firstname && firstname.length < 3)
            errors.firstname = 'Firsname should be greater than 3 letters';
        else if (this.state.touched.firstname && firstname.length > 10)
            errors.firstname = 'Firsname cannot be greater than 10 letters';
        if (this.state.touched.lastname && lastname.length < 3)
            errors.firstname = 'Lastname should be greater than 3 letters';
        else if (this.state.touched.lastname && lastname.length > 10)
            errors.firstname = 'Lastname cannot be greater than 10 letters';
        const reg = /^\d+$/;
        if (this.state.touched.telnum && !reg.test(telnum))
            errors.telnum = 'Tel. number should only contain numbers';
        if (this.state.touched.email && email.split().filter(x => x === '@').length !== 1)
            errors.email = 'email should consist of atleast one @';
        return errors;
    }
    render() {
